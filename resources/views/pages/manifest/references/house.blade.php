<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card card-danger">
            <div class="card-header">
                <div class="card-title">Customs</div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="form-group form-group-sm row">
                                        <label for="KATEGORI_BARANG_KIRIMAN" class="col-sm-4 col-form-label-sm">Kategori Barang Kiriman</label>
                                        <div class="col-sm-8">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="JNS_AJU" id="JNS_AJU"
                                ...
                                {{ $disabled }}>
                            @forelse (jenisAju() as $aju)
                            <option value="{{ $aju->val }}" data-ref="{{ $aju->ref }}"
                                    @selected($item->JNS_AJU == $aju->val)>
                            {{ $aju->desc }}</option>
                            @empty
                    ...
                    <div class="col-lg-6">
                        ...
                        <x-select2-ajax id="KD_DOC" name="KD_DOC"
                            :route="route('select2.docs')" placeholder="Select.."
                    ...
                    <div class="col-lg-6">
                        ...
                        <x-select2-ajax id="KD_KANTOR" name="KD_KANTOR"
                            :route="route('kpbc.search')" placeholder="Select.."
                            width="100%" required="required">
                            @if($item->KPBC)
    ...
    <div class="col-lg-4">
        <div class="card card-info ">
            <div class="card-header">
                <div class="card-title">Airline</div>
            </div>
            <div class="card-body">
                    <div class="row">
                    <!-- Partial -->
    ...
    <div class="col-lg-4">
        <div class="card card-info ">
            <div class="card-header bg-secondary">
                <div class="card-title">Master & House</div>
            </div>
            <div class="card-body">
                <div class="row">
                <!-- Master No -->
                ...
                <div class="col-lg-6">
                    ...
                    <x-select2-ajax id="KD_PEL_MUAT" name="KD_PEL_MUAT"
                ...
                <div class="col-lg-6">
                    ...
                    <x-select2-ajax id="KD_PEL_TRANSIT" name="KD_PEL_TRANSIT"
                    :route="route('origin.search')" placeholder="Select.."
                    width="100%"
                    >
                ...
                <div class="col-lg-6">
                    ...
                    <x-select2-ajax id="KD_PEL_AKHIR" name="KD_PEL_AKHIR"
                    :route="route('origin.search')" placeholder="Select.."
                    width="100%"
                    >
                ...
                <div class="col-lg-6">
                    ...
                    <x-select2-ajax id="KD_PEL_BONGKAR" name="KD_PEL_BONGKAR"
                    :route="route('origin.search')" placeholder="Select.."
                    width="100%"
                    >
        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <x-select2-ajax id="NM_PENGIRIM" name="NM_PENGIRIM"
                    :route="route('select2.company')" placeholder="Select.."
                    width="100%" required="required">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <x-select2-ajax id="NM_PENERIMA" name="NM_PENERIMA"
                    :route="route('select2.company')" placeholder="Select.."
                    width="100%" required="required">
                    @if(old('NM_PENERIMA') || $item->NM_PENERIMA)
                    <option value="{{ old('NM_PENERIMA') ?? $item->NM_PENERIMA }}" selected>
                    {{ old('NM_PENERIMA') ?? $item->NM_PENERIMA }} || {{ old('AL_PENGIRIM') ?? $item->AL_PENGIRIM }}
                    </option>
                    @endif
                </x-select2-ajax>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <select name="JNS_ID_PENERIMA"
                        ...
                        <option value="6"
                        @selected( old('JNS_ID_PENERIMA') == 6
                                    || $item->JNS_ID_PENERIMA == 6)>
                        6-NPWP 16 DIGIT</option>
                    </select>
                    </div>
                </div>
                <!-- Badan Usaha -->
                <div class="col-lg-6">
                    ...
                    <select name="BADAN_USAHA"
                            ...
                            {{ $disabled }}>
                        <option value="2"
                        @selected( old('BADAN_USAHA') == 2
                                    || $item->BADAN_USAHA == 2)>
                        TIDAK</option>
                        <option value="1"
                        @selected( old('BADAN_USAHA') == 1
                                    || $item->BADAN_USAHA == 1)>
                        YA</option>
                    </select>
                    </div>
