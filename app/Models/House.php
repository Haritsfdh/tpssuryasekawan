...
class House extends Model
{
    ...
    {
      $fob = ($this->KD_VAL == 'USD') ? $this->FOB : $this->details()->sum('CIF_USD');

      if ($this->JNS_AJU == 'C6') {
        $fob = ($fob > 1500) ? $fob - 1500 : 0;
      }
    ...
    // public function jobheader()
    // {
    //   return $this->morphOne(ShipmentsJobHeader::class, 'tpsable', 'JH_ModelType', 'JH_ParentID');
    // }

    // public function jobcharges()
    // {
    //   return $this->belongsToMany(ShipmentsJobBilling::class, 'fms_job_charges_lines', 'house_id', 'charge_id')->withPivot(['invoice_ar', 'invoice_ap'])->withTimestamps();
    // }
    ...
    // public function kerry()
    // {
    //   return $this->hasOne(KerryManifestDetail::class, 'AWB', 'NO_BARANG');
    // }
    ...
    // public function sppbmcp40()
    // {
    //   return $this->hasOne(BillingConsolidationSppbmcp40::class, 'nomorBarang', 'NO_BARANG');
    // }
